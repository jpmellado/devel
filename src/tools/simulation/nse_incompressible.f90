...
subroutine NSE_Incompressible()
    ...
    ! Scalar equations
    do is = 1, inb_scal
        call OPR_Burgers_X(OPR_B_U_IN, is, imax, jmax, kmax, s(:, is), u, tmp1, tmp9, tmp4) ! tmp4 contains u transposed
        call OPR_Burgers_Y(OPR_B_U_IN, is, imax, jmax, kmax, s(:, is), v, tmp2, tmp9, tmp5) ! tmp5 contains v transposed
        call OPR_Burgers_Z(OPR_B_U_IN, is, imax, jmax, kmax, s(:, is), w, tmp3, tmp9, tmp6) ! tmp6 contains w transposed
